function fetchWeather(cityName) {
    ...
    var currentWeatherURL = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&units=imperial&appid=${weatherKey}`;
    var forecastURL = `https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&units=imperial&appid=${weatherKey}`;
    ...
    fetch(currentWeatherURL)
        ...
        .then(data => {
            ...
            var temperature = data.main.temp + " °F";
    ...
    fetch(forecastURL)
        ...
        .then(data => {
            ...
            for (var i = 0; i < data.list.length; i += 8) {
                ...
                var windSpeed = forecastData.wind.speed +' mph'
